...
public enum Instruction {
    ...
    Ox06(ARITHMETIC_SHIFT_LEFT, ZERO_PAGE,              0x06, 2),

    Ox08(PUSH_PROC_STATUS_TO_SP,IMPLIED,                0x08, 1),
    Ox09(BITWISE_OR,            IMMEDIATE,              0x09, 2),
    Ox0A(ARITHMETIC_SHIFT_LEFT, ACCUMULATOR,            0x0A, 1),

    Ox0D(BITWISE_OR,            ABSOLUTE,               0x0D, 3),
    Ox0E(ARITHMETIC_SHIFT_LEFT, ABSOLUTE,               0x0E, 3),

    // endregion
    // region Row 1

    Ox10(BRANCH_IF_PLUS,        RELATIVE,               0x10, 2),
    Ox11(BITWISE_OR,            POST_INDEXED_INDIRECT_Y,0x11, 2),

    Ox15(BITWISE_OR,            INDEXED_ZERO_PAGE_X,    0x15, 2),
    Ox16(ARITHMETIC_SHIFT_LEFT, INDEXED_ZERO_PAGE_X,    0x16, 2),

    Ox18(CLR_CARRY,             IMPLIED,                0x18, 1),
    Ox19(BITWISE_OR,            INDEXED_ABSOLUTE_Y,     0x19, 3),

    Ox1D(BITWISE_OR,            INDEXED_ABSOLUTE_X,     0x1D, 3),
    Ox1E(ARITHMETIC_SHIFT_LEFT, INDEXED_ABSOLUTE_X,     0x1E, 3),
    ...
    Ox28(PULL_PROC_STATUS_FROM_SP, IMPLIED,             0x28, 1),
    ...
    Ox30(BRANCH_IF_MINUS,       RELATIVE,               0x30, 2),
    ...
    Ox46(LOGICAL_SHIFT_RIGHT,   ZERO_PAGE,              0x46, 2),

    Ox48(PUSH_A,                IMPLIED,                0x48, 1),
    Ox49(BITWISE_XOR,           IMMEDIATE,              0x49, 2),
    Ox4A(LOGICAL_SHIFT_RIGHT,   ACCUMULATOR,            0x4A, 1),

    Ox4C(JUMP_TO,               ABSOLUTE,               0x4C, 3),
    Ox4D(BITWISE_XOR,           ABSOLUTE,               0x4D, 3),
    Ox4E(LOGICAL_SHIFT_RIGHT,   ABSOLUTE,               0x4E, 3),
    ...
    Ox56(LOGICAL_SHIFT_RIGHT,   INDEXED_ZERO_PAGE_X,    0x56, 2),
    ...
    Ox5E(LOGICAL_SHIFT_RIGHT,   INDEXED_ABSOLUTE_X,     0x5E, 3),
    ...
    OxC0(COMPARE_Y,             IMMEDIATE,              0xC0, 2),
    OxC1(COMPARE_A,             PRE_INDEXED_INDIRECT_X, 0xC1, 2),

    OxC4(COMPARE_Y,             ZERO_PAGE,              0xC4, 2),
    OxC5(COMPARE_A,             ZERO_PAGE,              0xC5, 2),
    OxC6(DECREMENT_MEMORY,      ZERO_PAGE,              0xC6, 2),

    OxC8(INCREMENT_Y,           IMPLIED,                0xC8, 1),
    OxC9(COMPARE_A,             IMMEDIATE,              0xC9, 2),
    OxCA(DECREMENT_X,           IMPLIED,                0xCA, 1),

    OxCC(COMPARE_Y,             ABSOLUTE,               0xCC, 3),
    OxCD(COMPARE_A,             ABSOLUTE,               0xCD, 3),
    OxCE(DECREMENT_MEMORY,      ABSOLUTE,               0xCE, 3),

    // endregion
    // region Row D

    OxD0(BRANCH_IF_NOT_EQUAL,   RELATIVE,               0xD0, 2),
    OxD1(COMPARE_A,             POST_INDEXED_INDIRECT_Y,0xD1, 2),

    OxD5(COMPARE_A,             INDEXED_ZERO_PAGE_X,    0xD5, 2),
    OxD6(DECREMENT_MEMORY,      INDEXED_ZERO_PAGE_X,    0xD6, 2),

    OxD8(CLR_DECIMAL,           IMPLIED,                0xD8, 1),
    OxD9(COMPARE_A,             INDEXED_ABSOLUTE_Y,     0xD9, 3),

    OxDD(COMPARE_A,             INDEXED_ABSOLUTE_X,     0xDD, 3),
    OxDE(DECREMENT_MEMORY,      INDEXED_ABSOLUTE_X,     0xDE, 3),

    // endregion
    // region Row E

    OxE0(COMPARE_X,             IMMEDIATE,              0xE0, 2),
    OxE1(SUBTRACT_WITH_CARRY,   PRE_INDEXED_INDIRECT_X, 0xE1, 2),

    OxE4(COMPARE_X,             ZERO_PAGE,              0xE4, 2),
    OxE5(SUBTRACT_WITH_CARRY,   ZERO_PAGE,              0xE5, 2),
    OxE6(INCREMENT_MEMORY,      ZERO_PAGE,              0xE6, 2),

    OxE8(INCREMENT_X,           IMPLIED,                0xE8, 1),
    OxE9(SUBTRACT_WITH_CARRY,   IMMEDIATE,              0xE9, 2),
    OxEA(NO_OPERATION,          IMPLIED,                0xEA, 1),

    OxEC(COMPARE_X,             ABSOLUTE,               0xEC, 3),
    OxED(SUBTRACT_WITH_CARRY,   ABSOLUTE,               0xED, 3),
    OxEE(INCREMENT_MEMORY,      ABSOLUTE,               0xEE, 3),

    // endregion
    // region Row F

    OxF0(BRANCH_IF_EQUAL,       RELATIVE,               0xF0, 2),
    OxF1(SUBTRACT_WITH_CARRY,   POST_INDEXED_INDIRECT_Y,0xF1, 2),

    OxF5(SUBTRACT_WITH_CARRY,   INDEXED_ZERO_PAGE_X,    0xF5, 2),
